...
let z;
z = 41;
z = "abc"; // (6) oh no! This isn't good 🚨 ERROR : Type 'number' is not assignable to type 'string'
...
// bb = [1, 2, 3]; 🚨 ERROR : Type 'number, string, string, number' is not assignable to type 'number, number, number'
